...
class GELayerS1(nn.Module):
    def __init__(self, in_channel, out_channel, exp_ratio=6):
        ...
        self.conv1 = ConvBlock(
            in_channel=in_channel, out_channel=out_channel, kernel_size=3, stride=1
        )
...
class GELayerS2(nn.Module):
    def __init__(self, in_channel, out_channel, exp_ratio=6):
        ...
        b_channel = in_channel * exp_ratio
        self.conv1 = ConvBlock(
            in_channel=in_channel, out_channel=in_channel, kernel_size=3, stride=1
        )
...
class SegmentHead(nn.Module):
    def __init__(self, in_channel, seghead_ratio, n_classes, dropout_rate=0.1):
        ...
        self.conv_out = nn.Conv2d(
            b_channel, n_classes, kernel_size=1, stride=1, padding=0, bias=True
        )
